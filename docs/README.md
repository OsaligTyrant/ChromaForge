...
- Layout Editor: manual drag-and-drop layout with grid/free-form, optional guides, JSON layouts saved alongside output, plus recent JSON and drag-and-drop JSON loading.
